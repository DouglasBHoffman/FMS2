...
: go 90000000 0 do p2 point :get 2drop r2 rect :get 2drop 2drop loop ;
...
early bind using <- = 1512 w\ fmsCheck? false
early bind using <classname> = 1513 w\ fmsCheck? false
...
include /Users/doughoffman/FMS2VT/stack.f 
